 ...
 */
@Controller
@RequestMapping(value="web/permission/userdp")
public class UserDPController extends BaseController {

	private final static Logger logger = LoggerFactory.getLogger(UserDPController.class);
...
//==========================================数据操作=================================================/
	...
	public Object getUserListByPage(@ModelAttribute PageBean page, @ModelAttribute UserDTO userDto) {
		...
		userDto.setCreaterId(userVO.getId());
		return userService.getUserByPageDP(page, userDto);
	}
	...
	public Object addUser(@ModelAttribute UserRoleDTO userDto) {
		...
		userDto.setRoleCode(RoleEnum.MERCHANT.getCode());
