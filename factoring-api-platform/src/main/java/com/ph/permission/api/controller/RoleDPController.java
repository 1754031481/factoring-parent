 ...
 */
@Controller
@RequestMapping(value="web/permission/roledp")
public class RoleDPController extends BaseController{
	
	private static Logger logger = LoggerFactory.getLogger(RoleDPController.class);
...
//============================================数据操作================================================/
    ...
    public Object getRoleMenuByRoleId(Long roleId) {
        ...
        Result result = roleService.getRoleMenuAndMenuBtnByUserId(roleId,userVO.getId());
        return result;
    }
    ...
    public Object updateRoleMenu(@RequestBody GetMenuTreeDTO getMenuTreeDTO) {
        ...
        Map<Long, List<Long>> menuBtns = new HashMap<>(16);
...
//        role.setUpdaterId(sessionUserVO.getId());
    ...
    public Object listAll() {
        //查询店铺的roleCode
        SessionUserVO userVO=getLoginUser();
        return roleService.getRoleDPList(userVO.getId());
    }
    ...
    public Object addRole(@ModelAttribute Role role) {
        ...
        role.setUpdaterId(sessionUserVO.getId());
        role.setRoleCode(Byte.valueOf(RoleEnum.MERCHANT.getCode() + ""));
        //记录日志
