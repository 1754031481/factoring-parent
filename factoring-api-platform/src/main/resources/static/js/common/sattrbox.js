...
$(function () {
    ...
    function table_add(num,countNum) {
        ...
        for (var k = 0; k < tmpc.length; k++) {
            ...
            var buyinID=""+k+"five";
            var barcaID=""+k+"six";
            var weightID = ""+k+"seven";
            var lengthID = ""+k+"eight";
            var widthID = ""+k+"nine";
            var heightID = ""+k+"ten";
            /!*var jhID = ""+k+"eleven";*!/
            var scoreID = ""+k+"twelve";
            str1 += '<tr>'+
            '<td  class="td_input" style="width:14.2%">' + tmpc[k] + '<input type="hidden" ref="skus"   name="content" value="' + tmpc[k] + '" /></td>' +
            ...
            '<td class="td_input"><input type="text" class="table_input validate[required,custom[price], min[0]]" ref="skus" name="buyingPrice" id="'+buyinID+'" readonly="readonly" value="" /></td></tr>';
            str2 +='<tr>'+
                '<td class="td_input"><input type="text" class="table_input validate[required,custom[price], min[0]]" ref="skus" name="scoreIncome" id="'+scoreID+'" value="" /></td>' +
                '<td class="td_input"><input type="text" class="table_input validate[required,custom[price], min[0]]" ref="skus" name="weightIncome" id="'+weightID+'"  value="" /></td>' +
                '<td class="td_input"><input type="text" class="table_input validate[required,custom[price], min[0]]" ref="skus" name="lengthIncome" id="'+lengthID+'"  value="" /></td>' +
                '<td class="td_input"><input type="text" class="table_input validate[required,custom[price], min[0]]" ref="skus" name="widthIncome" id="'+widthID+'"  value="" /></td>' +
                '<td class="td_input"><input type="text" class="table_input validate[required,custom[price], min[0]]" ref="skus" name="heightIncome" id="'+heightID+'"  value="" /></td>' +
                /*'<td class="td_input"><input type="text" class="table_input validate[required,custom[price], min[0]]" ref="skus" name="jhIncome" id="'+jhID+'" readonly="readonly" value="" /></td>' +*/
        ...
        $('.ph_wareList .wareList_1').html(str1);
        $('.ph_wareList .wareList_2').html(str2);
            /*var priceID=""+k+"fir";
        	var countID=""+k+"one";
        	var platfID=""+k+"two";
        	var hunteID=""+k+"three";
