...
public enum PermissionEnum implements RespCode{
    ...
    ADDED_Classify_ERROR("10027", "咨询类别已存在"),
    ...
    ADD_Classify_ERROR("10025", "新增咨询分类异常"),
    UPDATE_Classify__ERROR("10026", "修改资讯分类异常"),
    NO_DATA("10027", "无数据"),
    CONSULTATION_PASS("10028", "咨询审核通过异常"),
    CONSULTATION_BACK("10028", "咨询审核驳回异常"),
    CONSULTATION_DETAIL("10029", "咨询详情查看异常"),
    ATTACHMENT_DETAIL("10030", "咨询图片查看异常"),
