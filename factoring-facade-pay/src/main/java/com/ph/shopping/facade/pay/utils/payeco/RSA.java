...
public class RSA {
	...
	//˽Կǩ��
    public static String sign(String data, String pfxPath, String keyPass) {

        try {

            RSAPrivateKey pbk = getPrivateKey(pfxPath, keyPass);
    ...
    //˽Կǩ��2048
    public static String signSHA(String data, String pfxPath, String keyPass) {
	...
	public static String encrypt(String data,String pubKey) {
	 ...
	 //��Կ����
		public static byte[] encrypt64(String data,String pubKey) {
    ...
    //��Կ��ǩ
    public static boolean verify(String data, String pubKey, String value) {

        try {
        	byte[] bts_data = Base64.decode(data);
        	byte[] bts_key = Base64.decode(pubKey);
    ...
    //��Կ��ǩ
    public static boolean verifySHA(String data, String pubKey, String value) {
