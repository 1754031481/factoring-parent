...
public class RoleServiceImpl implements IRoleService {
    ...
    public Result addRole(Role role) {
    	try {
			...
			if (roleMapper.selectCount(role)>0){
				return ResultUtil.getResult(PermissionEnum.Code.ROLE_NAME_EXIST);
			}
	...
	@Override
	public Result getRoleDPList(Long createId) {
		int type=0;
		return ResultUtil.getResult(PermissionEnum.Code.SUCCESS, roleMapper.getAllRoleDP(type));
	}
    ...
    public Result getRoleMenuAndMenuBtnByRoleId(Long roleId) {
        ...
        /*List<MenuVO> list = menuMapper.getAllBaseMenu();*/
        List<Long> menuIds = roleMenuMapper.selectRoleMenuByRoleId(roleId);
       /* List<Long> menuIds = roleMenuMapper.selectRoleMenu();*/
	...
	@Override
	public Result getRoleMenuAndMenuBtnByUserId(Long roleId, Long userId) {
		...
		//treevo 转换
		return ResultUtil.getResult(PermissionEnum.Code.SUCCESS, paramsTrans(insertBtn(menuVos, roleId), menuIds));
	}
