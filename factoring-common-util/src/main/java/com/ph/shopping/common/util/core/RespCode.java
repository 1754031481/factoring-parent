...
public interface RespCode {
    ...
    enum Code implements RespCode {
		...
		INSUFFICIENT_STORE_BALANCE("10119","店铺余额不足"),
		PRODUCT_NO("30300","商品不存在"),
		PRODUCT_OFF_THE_SHELF("30331","该商品已下架"),
		PRODUCT_NO_STOCK("30332","该商品库存不足");
        private String code;
        private String msg;
