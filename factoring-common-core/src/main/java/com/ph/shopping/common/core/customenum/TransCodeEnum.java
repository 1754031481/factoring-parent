...
//	MEMBER_CASH(1015,"会员提现",-1,"增加会员提现流水"),
	...
	// PROMOTER_PROFIT(1021, "服务专员分润", 1, "线下订单服务专员分润"),
	...
	/**
	 *扣除提现累计积分 会员提现失败扣除提现累计积分
	 */
	MEMBER_DRAWCASH_FAIL_REDUCE(1038, "扣除提现累计积分", -1, "会员提现失败扣除提现累计积分"),
	/**
	 *猎头订单返会员待用积分
	 */
	HUNTER_ORDER_RETURN_SCORE(1037, "猎头订单返会员待用积分", 1, "猎头订单返会员待用积分"),
	...
	/**
	 *线下订单分润增加服务专员可用积分 交易码
	 */
	UNLINE_ORDER_PROFIT_ADD_SCORE_TRANSCODE(1051, "线下订单分润增加服务专员可用积分", 1, "线下订单分润增加服务专员可用积分"),
	...
	/**
	 *线上订单分润增加服务专员可用积分 交易码
	 */
	ONLINE_ORDER_PROFIT_ADD_SCORE_TRANSCODE(1055, "线上订单分润增加服务专员可用积分", 1, "线上订单分润增加服务专员可用积分"),
	...
	/**
	 *猎头订单分润增加用户余额 交易码(供应链)
	 */
	HUNTER_ORDER_PROFIT_CHAIN_TRANSCODE(1057, "线上订单分润增加用户余额 (供应链)", 1, "线上订单分润增加用户余额(供应链)"),

	/**
	 *猎头订单分润增加服务专员可用积分 交易码
	 */
	HUNTER_ORDER_PROFIT_ADD_SCORE_TRANSCODE(1058, "线上订单分润增加服务专员可用积分", 1, "线上订单分润增加服务专员可用积分"),
	...
	/**
	 *1068,"推广用户积分提现失败",1,"推广用户积分"
	 */
	SHARE_MEMBER_CASH_FAIL(1068,"推广用户积分提现失败",1,"推广用户积分"),

	/**
	 *1069,"推广商户积分提现失败",1,"推广商户积分"
	 */
