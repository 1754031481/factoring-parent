...
import com.ph.shopping.common.core.config.properties.SmsConfigProperties;
  ...
  /* *//**
	...
	* @throws
	...
	public boolean sendSmsByNoMsg(String phone,String type){
		...
		try {
			...
			data.setSendUrl(smsConfigProperties.getSendUrl());
	...
	* @throws
	...
	public boolean verifySmsCode(String phone, String type, String code) {
		...
		try {
			...
			data.setSmsCodeCheckUrl(smsConfigProperties.getCheck());
	...
	* @throws
	...
	public Result sendSmsCodeByPassword(String phone, String password) {
		...
		return sendSmsCodeByMsg(phone, message, Integer.parseInt(smsConfigProperties.getPwdModelCode()));
	}
	/**
	 * 
	...
	public Result sendSmsCodeBySmsCode(String phone, String smsCode){
		...
		return sendSmsCodeByMsg(phone, message, Integer.parseInt(smsConfigProperties.getSmsModelCode()));
	}
	/**
	 * 
	 * @Title: sendSmsCodeByMsg   
	...
	public Result sendSmsCodeByMsg(String phone, Object[] message, int tplId) {
		...
		try {
			modelData.setAppKey(smsConfigProperties.getAppkey());
			modelData.setNationcode(smsConfigProperties.getSmsNationcode());
			modelData.setPhone(phone);
			modelData.setSdkappid(smsConfigProperties.getSendSdkappid());
			modelData.setSign(smsConfigProperties.getSmsSign());
			modelData.setTplId(tplId);
			modelData.setUrl(smsConfigProperties.getSendMsgUrl());
			modelData.setType(smsConfigProperties.getSmsSendTxtype());
